...
public class InheritanceAwareMongoRepositoryFactory extends MongoRepositoryFactory {
    ...
    protected Optional<QueryLookupStrategy> getQueryLookupStrategy(@Nullable Key key,
                                                                   @NotNull QueryMethodEvaluationContextProvider evaluationContextProvider) {
    ...
    private static class MongoQueryLookupStrategy implements QueryLookupStrategy {
        ...
        @NotNull
        @Override
        public RepositoryQuery resolveQuery(@NotNull Method method, @NotNull RepositoryMetadata metadata, @NotNull ProjectionFactory factory,
